    ...
    >
        {data.map((item) => (
            <SwiperSlide key={item.id}>
                ...
                <h2 className='font-patua-one text-xl mb-5 lg:px-36 lg:text-4xl'>{item.b}</h2>
                <p className='pb-5 mb-7 text-xs text-justify font-aleo font-light lg:px-36 lg:text-xl'>
